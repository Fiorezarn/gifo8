...
@section('content')
    ...
    <header class="masthead" id="header-main">
            <div class="container">
                ...
                <div class="masthead-subheading">Temukan inspirasi pakaian formal favorit anda sekarang</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#main-formal">Temukan</a>
            </div>
    </header>
    
    <section class="page-section " id="main-formal">
                <input class="finder" id="searchInput" type="text" placeholder="  Pencarian">
                <div class="myBoard" >
