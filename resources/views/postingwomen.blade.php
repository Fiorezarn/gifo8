...
@section('content')
    ...
    <header class="masthead" id="header-main">
            <div class="container">
                ...
                <div class="masthead-subheading">Temukan inspirasi ootd perempuan favorit anda sekarang</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#main-perempuan">Temukan</a>
            </div>
    </header>
    <section class="page-section " id="main-perempuan">
