...
<html lang="en">
    <head>
        ...
        <title>Gates Inspirated Fashion Outfit</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/home">Login</a></li>
        ...
        <section class="page-section bg-light" id="profil">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted"><br>Ahmad Miftah Fachruddin<br>10120074<br>3KA26
                </div>
                <div class="row">
        ...
        <section class="page-section" id="Contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <br> Telp : 087772720307

                    <br> Email	: amiftah81@gmail.com
                    <br> Instagram : amf__27 <br> xxmips
                    <br> Twitter : xxmips </h3>
