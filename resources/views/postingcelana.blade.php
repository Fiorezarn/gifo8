...
@section('content')
    ...
    <header class="masthead" id="header-main">
            <div class="container">
                ...
                <div class="masthead-subheading">Temukan inspirasi celana favorit anda sekarang</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#main-celana">Temukan</a>
            </div>
    </header>

    <section class="page-section " id="main-celana">
