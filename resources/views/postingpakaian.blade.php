...
@section('content')
    ...
    <header class="masthead" id="header-main">
            <div class="container">
                ...
                <div class="masthead-subheading">Temukan inspirasi pakaian favorit anda sekarang</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#main-pakaian">Temukan</a>
            </div>
    </header>
    <section class="page-section " id="main-pakaian">
